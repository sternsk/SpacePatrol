...
describe("FrequencyClass", () => {
    ...
    context("Eval Types", () => {
        ...
        it("evalutes midi", () => {
            expect(Frequency(48, "midi").valueOf()).to.be.closeTo(TonalMidi.midiToFreq(48), 0.0001);
            expect(Frequency(69, "midi").valueOf()).to.be.closeTo(TonalMidi.midiToFreq(69), 0.0001);
        });
        it("evalutes hz", () => {
        ...
        it("can convert notes into frequencies", () => {
            expect(Frequency("C4").valueOf()).to.be.closeTo(Note.freq("C4"), 0.0001);
            expect(Frequency("D4").valueOf()).to.be.closeTo(Note.freq("D4"), 0.0001);
            expect(Frequency("Db4").valueOf()).to.be.closeTo(Note.freq("Db4"), 0.0001);
            expect(Frequency("E4").valueOf()).to.be.closeTo(Note.freq("E4"), 0.0001);
            expect(Frequency("F2").valueOf()).to.be.closeTo(Note.freq("F2"), 0.0001);
            expect(Frequency("Gb-1").valueOf()).to.be.closeTo(Note.freq("Gb-1"), 0.0001);
            expect(Frequency("A#10").valueOf()).to.be.closeTo(Note.freq("A#10"), 0.0001);
            expect(Frequency("Bb2").valueOf()).to.be.closeTo(Note.freq("Bb2"), 0.0001);
        });
        it("handles double accidentals", () => {
            expect(Frequency("Cbb4").valueOf()).to.be.closeTo(Note.freq("Cbb4"), 0.0001);
            expect(Frequency("Dx4").valueOf()).to.be.closeTo(Note.freq("Dx4"), 0.0001);
            expect(Frequency("Dbb4").valueOf()).to.be.closeTo(Note.freq("Dbb4"), 0.0001);
            expect(Frequency("Ex4").valueOf()).to.be.closeTo(Note.freq("Ex4"), 0.0001);
            expect(Frequency("Fx2").valueOf()).to.be.closeTo(Note.freq("Fx2"), 0.0001);
            expect(Frequency("Gbb-1").valueOf()).to.be.closeTo(Note.freq("Gbb-1"), 0.0001);
            expect(Frequency("Ax10").valueOf()).to.be.closeTo(Note.freq("Ax10"), 0.0001);
            expect(Frequency("Bbb2").valueOf()).to.be.closeTo(Note.freq("Bbb2"), 0.0001);
        });
        it("can accomidate different concert tuning", () => {
            FrequencyClass.A4 = 444;
            expect(Frequency("C4").valueOf()).to.be.closeTo(TonalMidi.midiToFreq(TonalMidi.toMidi("C4"), FrequencyClass.A4), 0.0001);
            expect(Frequency("D1").valueOf()).to.be.closeTo(TonalMidi.midiToFreq(TonalMidi.toMidi("D1"), FrequencyClass.A4), 0.0001);
    ...
    context("Conversions", () => {
        it("can convert frequencies into notes", () => {
            expect(Frequency(261.625).toNote()).to.equal(Note.fromFreq(261.625));
        ...
        it("can convert note to midi values", () => {
            expect(Frequency("C4").toMidi()).to.equal(TonalMidi.toMidi("C4"));
            expect(Frequency("C#0").toMidi()).to.equal(TonalMidi.toMidi("C#0"));
            expect(Frequency("A-1").toMidi()).to.equal(TonalMidi.toMidi("A-1"));
        });
